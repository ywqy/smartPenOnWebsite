...
Line.prototype={
    ...
    addPath:function(cav){
        var canvasOriginPointX=cav.getBoundingClientRect().left;
        var canvasOriginPointY=cav.getBoundingClientRect().top;
        this.pathDuringX.push(event.pageX-canvasOriginPointX);
        this.pathDuringY.push(event.pageY-canvasOriginPointY);
...
canvas.addEventListener("mousedown",function(){
    canvas.addEventListener("mousemove",movFuc,false);
},false);
canvas.addEventListener("mouseup",function(){
    lines.array.push(line);
    line=new Line("rgb(100,100,100)",2,null);
    canvas.removeEventListener("mousemove",movFuc,false);
},false);
