 ...
 * http://modernizr.com/download/?-canvas-canvastext-eventlistener-setclasses !*/
!function(e, n, t) {
    function a(e, n) {
        return typeof e === n
    }
    function s() {
        ...
        for (var f in l)
            if (l.hasOwnProperty(f)) {
                ...
                for (s = a(n.fn, "function") ? n.fn() : n.fn,
                         o = 0; o < e.length; o++)
                    i = e[o],
                        c = i.split("."),
                        1 === c.length ? Modernizr[c[0]] = s : (!Modernizr[c[0]] || Modernizr[c[0]] instanceof Boolean || (Modernizr[c[0]] = new Boolean(Modernizr[c[0]])),
                            Modernizr[c[0]][c[1]] = s),
                        r.push((s ? "" : "no-") + c.join("-"))
            }
    }
